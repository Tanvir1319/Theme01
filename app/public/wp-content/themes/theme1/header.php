   ...
   <section class="header-top">
			<div class="container">
				<div class="row">
                  ...
                  $phn=get_field('phone_number', 'option'); 
                  ...
                  ?>
                     ...
                     <?php if($phn){ ?>
							<a href="Tel:<?php echo $phn ?>"><i class="fa fa-phone"></i> <?php echo $phn ?></a>
                     <?php } ?>
						</div>
					</div>
                  ...
                  ?>
							<a href="<?php echo the_sub_field('social_media_link'); ?>"><i class="fa <?php echo the_sub_field('icon'); ?>"></i></a>
